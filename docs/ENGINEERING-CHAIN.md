...
|---|---|---|
| Architecture | [ARCHITECTURE.md](../ARCHITECTURE.md) | Inference routing/admission/runtime adapter boundaries and system boundaries |
| ADR | [0001-serving-boundaries.md](../ADRs/0001-serving-boundaries.md) | Explicit design trade-offs and production boundaries |
