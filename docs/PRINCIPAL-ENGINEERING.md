...
## Core boundary
**Primary concern:** Inference.

Separate routing, admission control, backend health, and runtime adapters; enforce bounded concurrency; normalize backend failures; propagate correlation IDs; test overload and no-backend paths.
